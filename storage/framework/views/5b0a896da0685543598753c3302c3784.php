<?php $__env->startSection('title', ($site['site_name'] ?? 'Oronno Plants').' - Your Premium Plant Store'); ?>
        ...
        <div class="flex flex-col lg:flex-row items-center gap-12">
            <div class="flex-1 text-center lg:text-left">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                    <a href="<?php echo e(route('products')); ?>" class="bg-white text-green-700 hover:bg-yellow-300 hover:text-green-900 font-bold px-8 py-4 rounded-full transition-all duration-300 shadow-lg text-lg">
                        <i class="fas fa-leaf mr-2"></i>Shop Plants
                    </a>
                    <a href="<?php echo e(route('about')); ?>" class="border-2 border-white text-white hover:bg-white hover:text-green-700 font-bold px-8 py-4 rounded-full transition-all duration-300 text-lg">
                        Learn More
                    </a>
                </div>
                <div class="flex gap-8 mt-10 justify-center lg:justify-start text-center">
                    ...
                    <div><div class="text-3xl font-extrabold text-yellow-300"><?php echo e(number_format($avgRating, 1)); ?>★</div><div class="text-green-200 text-sm">Average Rating (<?php echo e($totalReviews); ?> reviews)</div></div>
                </div>
            </div>
            <div class="flex-1 flex justify-center">
                <div class="relative">
                    <img src="<?php echo e(asset('images/herobanner.jpg')); ?>" 
...
<section class="bg-white border-b border-gray-100 sticky top-[68px] z-40 shadow-sm">
    <div class="container mx-auto px-6 py-4 flex gap-3 overflow-x-auto scrollbar-hide">
        <a href="<?php echo e(route('products')); ?>" class="whitespace-nowrap bg-green-600 text-white px-5 py-2 rounded-full text-sm font-semibold hover:bg-green-700 transition-colors flex-shrink-0"><i class="fas fa-leaf mr-1"></i> All Plants</a>
        <a href="<?php echo e(route('products')); ?>?category=indoor" class="whitespace-nowrap bg-gray-100 text-gray-700 px-5 py-2 rounded-full text-sm font-semibold hover:bg-green-100 hover:text-green-700 transition-colors flex-shrink-0"><i class="fas fa-home mr-1"></i> Indoor</a>
        <a href="<?php echo e(route('products')); ?>?category=outdoor" class="whitespace-nowrap bg-gray-100 text-gray-700 px-5 py-2 rounded-full text-sm font-semibold hover:bg-green-100 hover:text-green-700 transition-colors flex-shrink-0"><i class="fas fa-tree mr-1"></i> Outdoor</a>
        <a href="<?php echo e(route('products')); ?>?plant_type=succulent" class="whitespace-nowrap bg-gray-100 text-gray-700 px-5 py-2 rounded-full text-sm font-semibold hover:bg-green-100 hover:text-green-700 transition-colors flex-shrink-0"><i class="fas fa-spa mr-1"></i> Succulents</a>
        <a href="<?php echo e(route('products')); ?>?plant_type=flowering" class="whitespace-nowrap bg-gray-100 text-gray-700 px-5 py-2 rounded-full text-sm font-semibold hover:bg-green-100 hover:text-green-700 transition-colors flex-shrink-0"><i class="fas fa-fan mr-1"></i> Flowering</a>
        <a href="<?php echo e(route('products')); ?>?plant_type=tree" class="whitespace-nowrap bg-gray-100 text-gray-700 px-5 py-2 rounded-full text-sm font-semibold hover:bg-green-100 hover:text-green-700 transition-colors flex-shrink-0"><i class="fas fa-seedling mr-1"></i> Trees</a>
        <a href="<?php echo e(route('products')); ?>?is_seasonal=1" class="whitespace-nowrap bg-gray-100 text-gray-700 px-5 py-2 rounded-full text-sm font-semibold hover:bg-green-100 hover:text-green-700 transition-colors flex-shrink-0"><i class="fas fa-star mr-1"></i> Seasonal</a>
    </div>
</section>
...
<section class="py-16 bg-white">
    <div class="container mx-auto px-6">
        ...
        <?php if(isset($plants) && $plants->count() > 0): ?>
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            <?php $__currentLoopData = $plants->take(8); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="group bg-white rounded-2xl shadow-sm hover:shadow-xl border border-gray-100 overflow-hidden transition-all duration-300 hover:-translate-y-1">
                <div class="relative overflow-hidden h-52">
                    <?php if($plant->image): ?>
                        <img src="<?php echo e(asset('images/plants/' . $plant->image)); ?>" alt="<?php echo e($plant->name); ?>"
                    ...
                    <div class="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-20 transition-all duration-300 flex items-center justify-center">
                        <div class="opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex gap-2">
                            ...
                            <button class="wishlist-btn bg-white text-red-500 p-2 rounded-full shadow-md hover:bg-red-50" data-plant-id="<?php echo e($plant->id); ?>">
                                <i class="far fa-heart"></i>
                            </button>
                            <?php endif; ?>
                            <a href="<?php echo e(route('products.show', $plant->id)); ?>" class="bg-white text-green-700 p-2 rounded-full shadow-md hover:bg-green-50">
                ...
                <div class="p-4">
                    <div class="flex gap-1 flex-wrap mb-2">
                        <?php if($plant->environment): ?>
                        <span class="text-xs bg-green-50 text-green-700 px-2 py-0.5 rounded-full font-medium"><?php echo e(ucfirst($plant->environment)); ?></span>
                        <?php endif; ?>
                        <?php if($plant->plant_type): ?>
                        <span class="text-xs bg-blue-50 text-blue-700 px-2 py-0.5 rounded-full font-medium"><?php echo e(ucfirst($plant->plant_type)); ?></span>
                        <?php endif; ?>
                    </div>
                    <h3 class="font-bold text-gray-800 mb-1 line-clamp-1"><?php echo e($plant->name); ?></h3>
                    <p class="text-gray-500 text-xs mb-3 line-clamp-2"><?php echo e($plant->description ?: 'Beautiful plant for your space.'); ?></p>
                    <div class="flex items-center justify-between">
                        <span class="text-xl font-extrabold text-green-600">৳<?php echo e(number_format($plant->price, 2)); ?></span>
                        <button class="add-to-cart-btn bg-green-600 hover:bg-green-700 text-white px-3 py-1.5 rounded-lg text-sm font-semibold transition-colors"
                            ...
                            <i class="fas fa-cart-plus mr-1"></i><?php echo e($plant->stock_count < 1 ? 'Sold Out' : 'Add'); ?>
        ...
        <div class="text-center mt-10">
            <a href="<?php echo e(route('products')); ?>" class="inline-block bg-green-600 hover:bg-green-700 text-white font-bold px-10 py-4 rounded-full transition-colors shadow-lg text-lg">
...
<section class="py-16 bg-gradient-to-r from-green-800 to-emerald-600 text-white">
    <div class="container mx-auto px-6">
        <div class="flex flex-col lg:flex-row items-center justify-between gap-8 text-center lg:text-left">
            ...
            <a href="<?php echo e(route('products')); ?>?is_seasonal=1" class="bg-yellow-400 hover:bg-yellow-300 text-green-900 font-extrabold px-10 py-4 rounded-full transition-colors shadow-lg text-lg whitespace-nowrap flex-shrink-0">
...
<section class="py-16 bg-gray-50">
    <div class="container mx-auto px-6">
        <div class="text-center mb-12">
            ...
            <p class="text-gray-500 max-w-xl mx-auto">Getting your dream plants delivered is easy with <?php echo e($site['site_name'] ?? 'Oronno Plants'); ?>.</p>
        </div>
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 relative">
            <div class="hidden md:block absolute top-10 left-1/4 right-1/4 h-0.5 bg-green-200 z-0"></div>
            <?php $__currentLoopData = [['fas fa-search','Browse','Explore our curated collection of 500+ plant varieties.'],['fas fa-shopping-cart','Select','Add your favourite plants to the cart.'],['fas fa-box','Order','Place your order with easy & secure checkout.'],['fas fa-leaf','Receive','Get fresh, healthy plants delivered to your door.']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="relative z-10 text-center">
                <div class="w-20 h-20 bg-white border-4 border-green-500 rounded-full flex items-center justify-center mx-auto mb-4 shadow-md"><i class="<?php echo e($step[0]); ?> text-green-600 text-2xl"></i></div>
                <div class="absolute -top-1 -right-1 md:right-auto md:-top-1 md:left-16 w-6 h-6 bg-green-600 text-white text-xs font-bold rounded-full flex items-center justify-center"><?php echo e($i+1); ?></div>
                <h3 class="font-bold text-lg text-gray-800 mb-2"><?php echo e($step[1]); ?></h3>
                <p class="text-gray-500 text-sm"><?php echo e($step[2]); ?></p>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <?php $__empty_1 = true; $__currentLoopData = $reviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="bg-gray-50 rounded-2xl p-6 border border-gray-100 hover:shadow-md transition-shadow">
                    ...
                    <p class="text-gray-700 mb-4 italic">"<?php echo e($review->comment); ?>"</p>
                    <div class="flex items-center gap-3">
                        <div class="w-10 h-10 bg-green-600 rounded-full flex items-center justify-center text-white font-bold">
                            <?php echo e(strtoupper(substr($review->user->fname ?? 'A', 0, 1))); ?>

                        </div>
                        <div>
                            <div class="font-semibold text-gray-800 text-sm"><?php echo e($review->user->fname ?? 'Anonymous'); ?> <?php echo e($review->user->lname ?? ''); ?></div>
...
<section class="py-20 bg-gradient-to-br from-green-600 to-emerald-700 text-white text-center">
    <div class="container mx-auto px-6">
        <div class="max-w-2xl mx-auto">
            ...
            <p class="text-green-200 text-lg mb-8">Join 10,000+ plant lovers who trust <?php echo e($site['site_name'] ?? 'Oronno Plants'); ?> for fresh, healthy, and beautiful plants.</p>
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="<?php echo e(route('products')); ?>" class="bg-white text-green-700 hover:bg-yellow-300 hover:text-green-900 font-extrabold px-8 py-4 rounded-full transition-all duration-300 shadow-lg text-lg">
                    <i class="fas fa-leaf mr-2"></i>Browse All Plants
                </a>
                <?php if(auth()->guard()->guest()): ?>
                <a href="<?php echo e(route('register')); ?>" class="border-2 border-white text-white hover:bg-white hover:text-green-700 font-extrabold px-8 py-4 rounded-full transition-all duration-300 text-lg">
                    Join Free Today
                </a>
                <?php endif; ?>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\alone\OneDrive\Desktop\Team Thunder\resources\views/home.blade.php ENDPATH**/ ?>