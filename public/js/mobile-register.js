...
function startOtpTimer() {
    ...
    console.log('Starting OTP timer, resendBtn:', resendBtn);
    
    // Hide resend button initially
    if (resendBtn) {
        resendBtn.style.display = 'none';
        console.log('Resend button hidden initially');
    }
    
    if (timerDisplay) {
        timerDisplay.textContent = '2:00';
        timerDisplay.classList.remove('expired');
        console.log('Timer display set to 2:00');
    }
    ...
    otpTimer = setInterval(() => {
        otpTimeRemaining--;
        console.log('OTP time remaining:', otpTimeRemaining);
        ...
        if (otpTimeRemaining <= 0) {
            ...
            if (resendBtn) {
                ...
                console.log('Resend button should now be visible');
            }
        }
    }, 1000);
}
